            ...
            <div class="category-product">
                <div class="row">
                                            ...
                                            if (isset($_GET['page'])) {
                                                ...
                                                $show=$a->getbycate($id_cg,$from,$number);
                                                foreach ($show as $key) {
                                                ?>
                            ...
                            <ul class="pagination">
                                <li><?php
                                    if($trang>1 && count($show)>=1){
                                        echo '<a href="index.php?p=product/product_cate.php&id_cg='.$id_cg.'&page='.($trang-1).'">Previous</a>';
                                    }
                                ?></li>
                            <?php for($i=1;$i<=$show[0]->sotrang;$i++) {?>
                            <li class="page-item <?= $i==$trang ? "active" :"" ?> "><a href="index.php?p=product/product_cate.php&id_cg=<?=$id_cg?>&page=<?=$i?>" ><?=$i?></a></li>
                            <?php } ?>
                            <li>
                                <?php
                                    if($trang<$show[0]->sotrang && count($show)>=1){
                                        echo '<a href="index.php?p=product/product_cate.php&id_cg='.$id_cg.'&page='.($trang+1).'">Next</a>';
                                    }
                                ?>
                            </li>
                        </ul>
